...
my_dict = "C:/Users/Johanan/OneDrive/Documents/HexCambridge/MindSpore/MindSpore_train_images_dataset"
...
def train_net(args, model, epoch_size, data_path, repeat_size, ckpoint_cb, sink_mode):
    ...
    ds_train = dm.create_dataset1(my_dict, True)
...
def test_net(network,model,data_path):
    ...
    ds_eval = dm.create_dataset1(my_dict, False) # test
